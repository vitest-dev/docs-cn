...
::: warning
不要忘记在每次测试运行前后清除或恢复模拟对象，以撤消运行测试时模拟对象状态的更改！有关更多信息，请参阅 [`mockReset`](/api/mock#mockreset) 文档。
:::

如果你想从头开始，请查看 [API](/api/#vi) 的 vi 部分，或者继续跟着文档深入了解一下这个对象模拟的世界。
...
MSW 能做的还有很多。你可以访问 cookie 和查询参数、定义模拟错误响应等等！要查看你可以使用 MSW 做什么，请阅读 [它们的文档](https://mswjs.io/docs)。
...
// 注意静态方法直接在函数上模拟，而非类实例上
Dog.getType = vi.fn(() => 'mocked animal')

// 对类的每个实例模拟 "speak" 和 "feed" 方法
// 所有 `new Dog()` 实例将继承这些监听方法
