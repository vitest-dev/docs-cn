...
- **命令行终端:** `--coverage.extension <extension>`
...
- **配置:** [browser.name](/config/#browser-name)
...
- **配置:** [browser.api.port](/config/#browser-api-port)
...
- **配置:** [browser.api.host](/config/#browser-api-host)
...
- **配置:** [browser.api.strictPort](/config/#browser-api-strictport)
...
- **配置:** [browser.provider](/config/#browser-provider)
...
- **命令行终端:** `--browser.providerOptions <options>`
- **配置:** [browser.providerOptions](/config/#browser-provideroptions)
...
- **配置:** [browser.fileParallelism](/config/#browser-fileparallelism)
